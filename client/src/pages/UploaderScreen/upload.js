  ...
  return (
    <div className="S-parent">
      ...
      <div className="S-final">
        {vidupload ? <Link to="/videolist"><button className="btn btn-success"><span><i class="fad fa-check-square S-icon"></i></span><span>Done</span></button></Link> : ""}
        {vidupload ? <Link to="/videolist"><button className="btn btn-danger"><span></span><i class="fad fa-times-circle S-icon"></i><span>Cancel</span></button></Link> : ""}
      </div>
    </div>
